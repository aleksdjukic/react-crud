...
class Editstudent extends Component
{
    ...
    async componentDidMount(){
        ...
        // console.log(stud_id)
        const res = await axios.get(`http://larareact-crud.test/api/edit-student/${stud_id}`);
    ...
    updateStudent = async (e) => {
        ...
        const stud_id = this.props.match.params.id;
        const res = await axios.put(`http://larareact-crud.test/api/update-student/${stud_id}`, this.state);
        if(res.data.status === 200){
            // console.log('res.data.message')
            swal({
                title: "Success!",
                        ...
                        <div className="card">
                            ...
                            <div className="card-body">
                                <form onSubmit={this.updateStudent}>
                                    ...
                                    <div className="form-group mb-3">
                                        <button type="submit" id="updatebtn" className="btn btn-primary">Update Atudent</button>
                                    </div>
                                </form>
                            </div>
                        </div>
